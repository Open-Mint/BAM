...
class MainWindow
{
    ...
    private:        
        ...
        void                   restart();
        void                      quit();
        void          updateHoverColor(sf::RectangleShape &button, sf::Text &text, sf::Color &buttonNormalColor, sf::Color &buttonHoverColor, sf::Color &normalTextColor, sf::Color &hoverTextColor);
    private:
        Bam player;
    private:
